...
public class UzytkownikBean implements Serializable {
	...
	public String addUzytkownik() {
		...
		*/
		...
		sluchacz.setPesel("89061205559");
		sluchacz.setAdresZamieszkania("ul. Chlebowa 3/32");
		sluchacz.setAdresKorespondencyjny("ul. Chlebowa 3/32");
		sluchacz.setImieMatki("Alicja");
		sluchacz.setImieOjca("Andrzej");
		sluchacz.setEmail("adrian.maciej@gmail.com");
		sluchacz.setTelefon("888386016");
		sluchacz.setHaslo("haslo");
		sluchacz.setAktywny(true);
		sluchacz.setImieOpiekunaK("Alicja");
		sluchacz.setImieOpiekunaM("Andrzej");
		sluchacz.setId(1);
		clearForm();
		return "";
	}
